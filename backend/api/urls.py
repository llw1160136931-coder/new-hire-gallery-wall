...
from .views import (
    ...
    TalentProfileReportFileView,
    TalentProfileReportView,
...
urlpatterns = [
    ...
    path('me/talent-profile/', TalentProfileReportView.as_view(), name='talent-profile'),
    path(
        'me/talent-profile/file/',
        TalentProfileReportFileView.as_view(),
        name='talent-profile-file',
    ),
